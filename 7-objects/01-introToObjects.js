/*
    - onjects are used to store multiple sets of data in the key/value pair format
    - denoted by {}.
*/
...
console.log(`Episode ${netflix.season1.seasonInfo.episodeInfo[2].episode}: ${netflix.season1.seasonInfo.episodeInfo[2].episodeName}`);
...
/*
    JSON Objects
        ...
        - jsonformatter.org to make it a bit more readable.
*/
